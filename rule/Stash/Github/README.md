...
Các quy tắc GitHub được tạo tự động bởi RULE GENERATOR Rule Generator。
...
Thời gian cập nhật cuối cùng：2024-02-25 16:01:10
...
#### Hướng dẫn sử dụng
- GitHub.yaml，Vui lòng sử dụng behavior: "classical"。

#### Đề xuất cấu hình
- GitHub.yaml Sử dụng một mình。

#### Liên kết quy tắc
**ME Chi nhánh (Cập nhật hàng ngày)**

https://raw.gitmirror.com/TenChina/All/me/rule/Stash/Github/Github.yaml
...
Dữ liệu của GitHub đến từ các liên kết sau. Nếu nó được trộn lẫn với các quy tắc GitHub của dự án này, nó có thể gây ra rất nhiều quy tắc trùng lặp。

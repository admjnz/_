...
CÁC QUY TẮC CỦA TRÒ CHƠI ĐƯỢC TẠO TỰ ĐỘNG BỞI TRÌNH TẠO QUY TẮC。
...
Chứa Steam、Blizzard、Discord、Rockstar Quy tắc chuyển hướng bình đẳng

## Thống kê quy tắc

Thời gian cập nhật cuối cùng：2024-02-25 16:01:07
...
#### Hướng dẫn sử dụng
- Game.yaml，Vui lòng sử dụng behavior: "classical"。
- Game-No-Resolve.yaml，Vui lòng sử dụng behavior: "classical"。

#### Đề xuất cấu hình
- Game.yaml Sử dụng một mình。
...
Dữ liệu của "Trò chơi" đến từ các liên kết sau. Nếu nó được trộn lẫn với các quy tắc "Trò chơi" của dự án này, nó có thể gây ra một số lượng lớn các quy tắc trùng lặp。
